...
public class FDVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public FDVideoView(Context context) {
        super(context);
        this.mContext = context;
        initVideoView();
    }

    public FDVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
        initVideoView();
    }

    public FDVideoView(Context context, AttributeSet attrs, int defStyle) {
